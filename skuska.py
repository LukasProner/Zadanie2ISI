...
# Konštanty pre veľkosť hracieho poľa
GRID_SIZE = 5
CELL_SIZE = 50

# Globálna premenná pre index hráča
PLAYER_INDEX = 0
...
# Figúrky a cieľ
players = [
    {"position": (4, 2), "color": "red"},  # Hlavný hráč
    {"position": (1, 1), "color": "blue"},
    {"position": (1, 3), "color": "green"},
    {"position": (4, 1), "color": "yellow"},
    {"position": (4, 0), "color": "orange"},
]
goal_position = (2, 2)  # Cieľ na hracej ploche
